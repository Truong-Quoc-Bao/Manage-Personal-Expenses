...
async function handleTransactionCreated(content, msg) {
  ...
  console.log(`[Budget] Handling transaction.created | trans_id: ${trans_id}, category: ${category_id}`);
  ...
  try {
    ...
    console.error(`[Budget] Error handling transaction.created:`, err.message);
  }
}
